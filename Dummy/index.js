...
let retrieveEnrtries = () => {
    ...
    try {
        let entries = localStorage.getItem("UserEntries");
        console.log("Retrieved entries from localStorage:", entries);
...
let ShowEntries = () => {
    ...
    console.log("Retrieved entries:", Entries, typeof Entries);
...
const saveUserForm = (event) => {
    ...
    Entries.push(entry);
    console.log("Entries before pushing new entry:", Entries);
