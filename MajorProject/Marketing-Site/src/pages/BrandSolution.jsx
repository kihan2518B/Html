        ...
        <div className="flex h-[100vh] bg-gray-100">
          <div className="w-[50vw] flex flex-col items-center justify-around">
            ...
            <div className="w-[39vw] h-[40vh] flex flex-wrap justify-around">
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/641d64fe6bc2e32b2eac9420_P_G-min-p-500.webp"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/641d64faa61ee055ad1cc612_glow_and_lovely_logo%20-%20Prajna%20Anchan-min.png"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/641d64fbfeac4725f998b8de_GarnierMen_NewLogo%20(1)%20-%20Copy%20-%20Richa%20Nadkarni(1)-min-p-500.webp"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/646f68e1e441809161cd5207_download.webp"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/641d64f9f0752c75fb64ffce_jio-logo%20(1)-min.png"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/64115e4b34e519f889ee3122_uno-logo.svg"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/641d64fb1c4a4faaa6fd4a17_Godrej___Boyce-Logo.wine%20-%20Sadhana%20Yadav-min-p-500.webp"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/64115e4c3b3a8496bd204d10_AL_Logo.svg"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
              <img
                src="https://assets-global.website-files.com/64081b3f2fda69c80b5566e5/641d5a3989b0aa7a4a169910_Dominos_Logo_png-min-p-500.png"
                alt=""
                className="w-[10vw] h-[10vh] object-contain"
              />
            </div>
          ...
          <div className="w-[50vw] flex flex-col justify-evenly items-center">
            ...
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
              <p>Original Content and Copywriting</p>
              <i className="fa-solid fa-chevron-down absolute right-0 "></i>
            </div>
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
              <p>Graphic Design, Iconography and Illustrations</p>
              <i className="fa-solid fa-chevron-down absolute right-0 "></i>
            </div>
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
            ...
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
              <p>Film Production, AVs and Product Photography</p>
              <i className="fa-solid fa-chevron-down absolute right-0 "></i>
            </div>
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
            ...
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
              <p>Spark Social Fluence & ORM</p>
              <i className="fa-solid fa-chevron-down absolute right-0 "></i>
            </div>
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
              <p>Print, OOH, Mainline Advertising</p>
              <i className="fa-solid fa-chevron-down absolute right-0 "></i>
            </div>
            <hr className="border-t border-gray-500 w-[40vw]" />
            <div className="flex relative w-[40vw] h-[5vh] items-center font-bold text-lg">
              <p>New Brand Launch and Rebranding</p>
              <i className="fa-solid fa-chevron-down absolute right-0 "></i>
            </div>
            <hr className="border-t border-gray-500 w-[40vw]" />
          </div>
        </div>
        <div className=" h-[210vh] w-full bg-gray-100">
          <div className=" h-[210vh] pt-14 mx-auto w-[80vw] flex flex-wrap overflow-hidden justify-around z-10">
            <Cart
              id="cart1"
            ...
            <Cart
              id="cart17"
              url="https://assets-global.website-files.com/64117da520cdfb7ab62144a5/647726b6bbb4647b00589d78_FEVICOL%20WEBSITE%20CASE%20STUDY%20M%20TEXT%20(Large)-p-500.png"
              title="Fevicol"
